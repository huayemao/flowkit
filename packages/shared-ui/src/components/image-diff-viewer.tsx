...
import { XIcon, MaximizeIcon, MinimizeIcon, MoveLeftIcon, MoveRightIcon, EyeIcon } from 'lucide-react';
...
export function ImageDiffViewer({
  ...
  return (
    <div
      className={cn(`fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 `, {
        'p-0': isMaximized
    ...
    >
      <div
        ref={containerRef}
        className={`bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col transition-all duration-300 ease-in-out ${isMaximized ? 'max-w-none max-h-none inset-0 m-0 rounded-none' : ''}`}
      >
        {/* 标题栏 */}
        <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between bg-gray-50 dark:bg-gray-950 rounded-t-xl">
