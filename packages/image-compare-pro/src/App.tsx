  ...
  return (
    <div className={`transition-all duration-300`}>
      ...
      <div className="fixed inset-0 overflow-hidden">
        ...
        <div className="absolute top-0 -right-4 w-96 h-96 bg-orange-300 dark:bg-orange-800 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-30 dark:opacity-40 animate-float-updown" />
